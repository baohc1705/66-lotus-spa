...
namespace _66SMS.Persistence.Configurations.Sql
{
    public class ServiceConfiguration : IEntityTypeConfiguration<Service>
    {
        public void Configure(EntityTypeBuilder<Service> builder)
        {
            ...
            builder.Property(x => x.CostPrice).HasColumnName(ServiceConst.FIELD_COST_PRICE);
            builder.Property(x => x.SellingPrice).HasColumnName(ServiceConst.FIELD_SELLING_PRICE);
            builder.Property(x => x.CommissionRate).HasColumnName(ServiceConst.FIELD_COMMISSION_RATE);
