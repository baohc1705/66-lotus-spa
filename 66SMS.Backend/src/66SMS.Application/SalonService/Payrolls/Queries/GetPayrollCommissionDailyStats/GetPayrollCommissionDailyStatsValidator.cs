...
{
    public class GetPayrollCommissionDailyStatsValidator
        : AbstractValidator<GetPayrollCommissionDailyStatsQuery>
    {
        public GetPayrollCommissionDailyStatsValidator()
        {
