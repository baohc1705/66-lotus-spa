...
export const FooterSection = () => {
  ...
  return (
    <footer id="footer" className="bg-lotus-deep pb-8 pt-12 text-white">
      <div className="landing-container">
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-10">
          <div className="lg:col-span-5">
            ...
            <p className="mb-8 max-w-sm font-geist text-sm leading-relaxed text-white/55">
              Không gian chăm sóc sức khỏe và sắc đẹp tại Cao Lãnh — nơi cơ thể tìm về sự tĩnh lặng.
            </p>

            <div className="space-y-3">
              <div className="flex items-start gap-3 text-sm text-white/55">
                <MapPin className="mt-0.5 h-4 w-4 shrink-0 text-lotus-gold" aria-hidden="true" />
                <span>123 Đường Lê Lợi, TP. Cao Lãnh, Đồng Tháp</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <Phone className="h-4 w-4 shrink-0 text-lotus-gold" aria-hidden="true" />
                <a
                  href="tel:0907959395"
                  className="landing-focus-ring text-white/55 transition-colors hover:text-lotus-gold"
                >
                  0907 95 93 95
                </a>
              </div>
              <div className="flex items-center gap-3 text-sm text-white/55">
                <Clock className="h-4 w-4 shrink-0 text-lotus-gold" aria-hidden="true" />
            ...
            <ul className="space-y-2.5">
              {NAV_LINKS.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="landing-focus-ring inline-flex items-center gap-1 font-geist text-sm text-white/55 transition-colors hover:text-lotus-gold"
                  >
                    {link.label}
          ...
          <div className="lg:col-span-4">
            ...
            {subscribed ? (
              <div className="flex items-center gap-2 text-lotus-gold">
                ...
                <span className="font-geist text-sm">Đã đăng ký thành công</span>
              </div>
            ) : (
              <form onSubmit={handleNewsletter} className="flex gap-2">
                ...
                <button
                  type="submit"
                  className="landing-focus-ring flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-lotus-rose text-white transition-colors hover:bg-lotus-rose-dark"
            ...
            <div className="mt-6 flex items-center gap-3">
              <a
                ...
                className="landing-focus-ring flex h-10 w-10 items-center justify-center rounded-full border border-white/15 text-white/55 transition-colors hover:border-lotus-gold/40 hover:text-lotus-gold"
              >
        ...
        <div className="mt-12 flex flex-col items-start justify-between gap-4 border-t border-white/10 pt-8 sm:flex-row sm:items-center">
          ...
          <div className="flex gap-5">
            ...
            <a href="/terms" className="landing-focus-ring font-geist text-xs text-white/40 hover:text-white/70">
              Điều khoản sử dụng
            </a>
          </div>
        </div>
