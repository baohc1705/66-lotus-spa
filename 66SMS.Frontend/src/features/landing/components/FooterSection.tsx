...
export const FooterSection = () => {
  ...
  return (
    <footer
      id="footer"
      className="py-16 md:py-20 bg-lotus-deep text-white"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8 mb-12">
          ...
          <div>
            ...
            <p className="font-sans text-sm text-white/60 leading-relaxed max-w-xs">
              Không gian chăm sóc sức khỏe và sắc đẹp,
              nơi cơ thể tìm về sự tĩnh lặng.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                <Phone className="w-4 h-4 text-lotus-gold shrink-0" />
                <a
              ...
              <li className="flex items-center gap-3">
                <Clock className="w-4 h-4 text-lotus-gold shrink-0" />
                <span className="font-sans text-sm text-white/60">
            ...
            <div className="flex items-center gap-3 mt-5">
              <a
                href="#"
                aria-label="Facebook"
                className="w-9 h-9 rounded-full border border-white/20 flex items-center justify-center text-white/60 hover:text-lotus-gold hover:border-lotus-gold/40 transition-all duration-300"
              >
            ...
            {subscribed ? (
              ...
              <form onSubmit={handleNewsletter} className="flex gap-2">
                <input
                  ...
                  required
                  className="flex-1 px-4 py-2.5 rounded-full bg-white/10 border border-white/20 font-sans text-sm text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-lotus-rose/30 focus:border-lotus-rose/40 transition-all"
                />
                <button
                  type="submit"
                  className="w-10 h-10 rounded-full bg-lotus-rose flex items-center justify-center text-white hover:bg-lotus-rose/80 transition-colors shrink-0"
