            ...
            <thead>
              <tr className="bg-lotus-cream">
                {['Tên quyền', 'Resource', 'Action', ''].map(h => (
                  <th
                    key={h}
                    className="px-3 py-2 text-left text-lotus-admin-base font-bold text-lotus-stone uppercase tracking-wide border-b border-border"
                  >
                    {h}
                  </th>
                ))}
              ...
              {permissions.map((p, i) => (
                <tr key={p.id} className={i % 2 === 0 ? 'bg-white' : 'bg-lotus-cream/40'}>
                  ...
                  <td className="px-3 py-2 border-b border-border">
                    <span className="text-lotus-admin-base bg-[rgba(62,122,62,0.1)] text-lotus-leaf rounded px-2 py-0.5 font-semibold">{p.resource}</span>
                  </td>
                  <td className="px-3 py-2 border-b border-border">
                    <span className="text-lotus-admin-base bg-lotus-cream text-lotus-stone rounded px-2 py-0.5 font-semibold">{p.action}</span>
                  </td>
