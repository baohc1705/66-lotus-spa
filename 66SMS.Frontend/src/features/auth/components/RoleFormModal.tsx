  ...
  return (
    <RolePermissionModal title={isEdit ? 'Chỉnh sửa vai trò' : 'Tạo vai trò mới'} onClose={onClose}>
      <div className="flex flex-col gap-4">
        <div>
          <label className="block text-xs font-semibold text-lotus-stone mb-1">Tên vai trò *</label>
          <input
        ...
        <div>
          ...
          <textarea
            className="w-full px-3 py-2 rounded-lg border border-border bg-white text-lotus-deep text-sm outline-none focus:border-lotus-leaf transition-colors resize-y min-h-[72px]"
            value={desc}
