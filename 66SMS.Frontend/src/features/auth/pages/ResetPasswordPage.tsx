...
export const ResetPasswordPage = () => (
  ...
  >
    <div className="flex flex-col items-center select-none mb-6">
      ...
      />
      <h2 className="font-display text-2xl font-semibold tracking-[0.1em] text-rose-400 uppercase">
        HOA SEN SPA
      </h2>
      <span className="text-xs tracking-[0.3em] text-rose-400/80 font-sans uppercase mt-1">
        ĐÔNG THÁP
      </span>
    </div>
    ...
    <div className="w-full max-w-[440px] bg-white rounded-[24px] p-8 sm:p-10 shadow-gold animate-fade-in">
      <div className="text-center mb-6">
        <h3 className="text-2xl font-bold text-ink font-sans">Đặt lại mật khẩu</h3>
