...
const STATUS_MAP: Record<number, { label: string; className: string }> = {
  0: { label: 'Tạm đóng', className: 'bg-state-warning-bg text-state-warning-text border-state-warning-border' },
  ...
  3: { label: 'Đóng cửa', className: 'bg-state-neutral-bg text-state-neutral-text border-state-neutral-border' },
}
