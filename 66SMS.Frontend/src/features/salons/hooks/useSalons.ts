...
const SALON_KEYS = {
  ...
  adminLists: () => [...SALON_KEYS.all, "admin-list"] as const,
  adminList: (params: SalonQueryParams) =>
    [...SALON_KEYS.adminLists(), params] as const,
...
export function useAdminSalons(params: SalonQueryParams) {
  return useQuery({
