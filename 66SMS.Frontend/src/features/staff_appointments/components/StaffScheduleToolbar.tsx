  ...
  return (
    <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4 bg-white/70 backdrop-blur-md p-4 rounded-admin border border-adminGray-100/30 shadow-sm">
      <div className="flex items-center gap-2">
        ...
        <div className="hidden lg:flex items-center gap-3 text-xs font-medium text-adminGray-600 ml-2 select-none">
      ...
      <div className="flex items-center gap-2 justify-end">
        <button
          ...
          onClick={handleToday}
          className={cn(
            "px-4 h-9 text-sm font-semibold rounded-lg border transition-all flex items-center justify-center",
            isToday
              ? "bg-primary text-white border-primary"
              : "bg-white text-adminInk border-adminGray-100/50 hover:bg-adminGray-50",
          )}
        >
          Hôm nay
        </button>
 
        <div className="flex items-center bg-adminGray-50 p-0.5 rounded-lg border border-adminGray-100/50 h-9">
          <button
            type="button"
            onClick={handlePrev}
            className="p-1.5 text-adminGray-600 hover:text-adminInk hover:bg-white rounded-md transition-all h-full flex items-center justify-center"
          >
