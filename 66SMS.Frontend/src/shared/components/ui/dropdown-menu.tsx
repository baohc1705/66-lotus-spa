    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          "bg-white rounded-xl shadow-xl py-2",
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        ...
        "py-2 pl-8 pr-4 text-sm outline-none transition-colors",
        "text-gray-600 focus:bg-gray-50 focus:text-gray-900",
        "data-disabled:pointer-events-none data-disabled:opacity-50",
        className,
      )}
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      className={cn(
        "px-4 py-2 text-xs font-bold text-gray-400 uppercase tracking-wider",
        "data-inset:pl-8",
        inset && "pl-8",
        className,
      )}
...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      className={cn("my-1 h-px bg-gray-100 -mx-0", className)}
      {...props}
    />
  )
}
