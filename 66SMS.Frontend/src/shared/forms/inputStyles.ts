...
export function inputControlClass(opts: {
  ...
  if (opts.invalid) {
    cls += "border-kit-danger text-kit-body focus:border-kit-danger focus:ring-2 focus:ring-red-500/25 ";
  } else if (opts.valid) {
    cls += "border-kit-success text-kit-body focus:border-kit-success focus:ring-2 focus:ring-green-500/25 ";
  } else {
    cls +=
